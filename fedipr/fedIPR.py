...
class IPRFederatedLearning(Experiment):
    ...
    def construct_model(self):
        ...
        if self.model_name == 'cnn' and self.dataset == 'cifar10':
            ...
            model = AlexNet(3,10,passport_kwargs = self.passport_kwargs)
        ...
        for epoch in range(self.epochs):
            ...
            if (epoch + 1) % 1 == 0:
                ...
                if epoch == self.epochs - 1:           
                    ...
                    to_csv(model_path+'/bits'+str(args.num_bit)+'_clients'+str(args.num_users)+'_'+str(self.malice_client_nums)+'_'+str(args.tampered_frac)+'.csv',test_acc_dict)
