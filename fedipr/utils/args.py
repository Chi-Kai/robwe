...
def parser_args():
    ...
    parser.add_argument('--local_ep', type=int, default=11,
    ...
    parser.add_argument('--iid',type=str,default ='noniid-#label4',
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10', 'cifar100','mnist','fmnist'], help="name of dataset")
    
    parser.add_argument('--data_root', default='data',
                        help='dataset directory')
    parser.add_argument('--save_path', default='fediprsave',
                        help='save directory')
    # =========================== Other parameters ===================================
