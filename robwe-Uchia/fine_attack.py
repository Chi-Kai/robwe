...
def main(args,seed,model_path):
    ...
    model.load_state_dict(model_clients[22])
    ...
    test_ldr_22 = DataLoader(DatasetSplit(dataset_test,dict_users_test[22]), batch_size = args.bs,
                                             shuffle=True, num_workers=2)
    ...
    train_ldr_1 = DataLoader(DatasetSplit(dataset_train,dict_users_train[1]), batch_size = args.bs,
                                             shuffle=True, num_workers=2)
    train_ldr_22 = DataLoader(DatasetSplit(dataset_train,dict_users_train[22]), batch_size = args.bs,
                                             shuffle=True, num_workers=2)
