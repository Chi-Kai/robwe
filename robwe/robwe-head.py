...
def main(args, seed):
    ...
    for iter in range(args.epochs):
        ...
        for ind, i in enumerate(idxs_users):
            ...
            #is_in_interval = check_confidence_interval(other_client_accs_in_i,all_detect_malice_clients_rates,client_accs_for_iter[i], args.confidence_level_nor,args.confidence_level_bad,args.bad_nums)
    ...
    if args.use_watermark:
        for i in range(args.num_users):
            ...
            for j in range(args.num_users):
                ...
                sign_acc = tester.test_signature(keys[j], 0)
...
if __name__ == "__main__":
    args = args_parser()
    frac = [0.1]
    embed_dims = [args.embed_dim]  # 8320
