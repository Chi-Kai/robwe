    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "mlr": # convex
            ...
            if args.dataset == "Cifar10":
                ...
                args.model = CNNCifar100(num_classes=100).to(args.device)
            elif args.dataset == "Mnist":
                args.model = CNNMnist(num_classes=10).to(args.device)
            elif args.dataset == "Femnist":
                args.model = CNN_FEMNIST(num_classes=10).to(args.device)
        elif model_str == "passportcnn":
            if args.dataset == "Cifar10":
                args.model = PassportCNNCifar(num_classes=10).to(args.device)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-mfc', "--malicious_frac", type=float, default=0.0,
                        help="The rate for malignant clients")
    parser.add_argument('-tfc', "--tampered_frac ", type=float, default=0.0,
                        help="The rate for malignant clients")
    ...
    parser.add_argument('-psd', "--passport_dir", type=str, default='items')
    # practical
